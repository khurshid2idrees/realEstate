            ...
            {property.map((item, index) => {
              return (
                ...
                >
                  <div
                    id="image-box"
                    className="bg-cover bg-center h-[250px] rounded-md p-4 flex flex-col justify-between items-end"
                  ...
                  >
                    ...
                    >
                      <div>
                        <button className="px-3 py-1 bg-gold hover:bg-white hover:text-black text-white rounded-full text-[13px]">
                          Featured
                        </button>
                      </div>
                  ...
                  <div className="px-6 py-3 flex flex-col justify-center items-start gap-2 w-full">
                    ...
                    <p className="text-textColor">{item.about} </p>
                    <div
                      id="icons"
                      className="flex justify-center items-start gap-4"
                    >
                      <div className="flex justify-center items-center gap-2">
                        <FaBath className="size-5 text-gold" />
                        <h1 className="">{item.bath}</h1>
                      </div>
                      <div className="flex justify-center items-center gap-2">
                        <FaBed className="size-5 text-gold" />
                        <h1 className="">{item.bed}</h1>
                      </div>
                      <div className="flex justify-center items-center gap-2">
                        <MdSpaceDashboard className="size-5 text-gold" />
                    ...
                    >
                      <div className="flex justify-center items-center gap-2 ">
                        <FaUserCircle className="size-5 text-gold" />
                      ...
                      <div className="flex justify-center items-center gap-4">
                        <div className="p-2 border-2 border-gray-200 hover:bg-black cursor-pointer transform hover:scale-110 transition-transform duration-300">
                          <FaShareAlt className="size-4 text-gold" />
                        </div>
                        <div className="p-2 border-2 border-gray-200 hover:bg-black cursor-pointer transform hover:scale-110 transition-transform duration-300">
                          <FaHeart className="size-4 text-gold" />
                        </div>
                        <div className="p-2 border-2 border-gray-200 hover:bg-black cursor-pointer transform hover:scale-110 transition-transform duration-300">
                          <FaPlus className="size-4 text-gold" />
                        </div>
                      </div>
                    </div> */}
                  </div>
